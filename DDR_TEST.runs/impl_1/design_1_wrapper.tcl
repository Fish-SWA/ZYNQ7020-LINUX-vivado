...
namespace eval ::optrace {
  variable script "F:/ZYNQ_LINUX/ZYNQ_DDR_TEST/DDR_TEST.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/ZYNQ_LINUX/ZYNQ_DDR_TEST/DDR_TEST.runs/synth_1/design_1_wrapper.dcp
